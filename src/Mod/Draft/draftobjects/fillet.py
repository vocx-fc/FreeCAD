...
class Fillet(base.DraftObject):
    ...
    def __init__(self, obj):
        ...
        # TODO: a new property here should link two straight lines
        # or edges so we can use them to build a fillet from them.
        # obj.addProperty("App::PropertyLinkGlobal", "Line1", "Draft",
        #                 QT_TRANSLATE_NOOP("App::Property",
        #                                   "First line used as reference."))
        # obj.addProperty("App::PropertyLinkGlobal", "Line2", "Draft",
        #                 QT_TRANSLATE_NOOP("App::Property",
        #                                   "Second line used as reference."))
    ...
    def _update_radius(self, obj, radius):
        if (hasattr(obj, "Line1") and hasattr(obj, "Line2")
            ...
            _msg("Recalculate the radius.")

        _msg("Currently not implemented. Update radius: {}".format(radius))
