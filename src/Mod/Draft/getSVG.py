...
# *                                                                         *
# ***************************************************************************
"""Provide code to convert certain shapes into SVG elements."""
## @defgroup getSVG getSVG
#  \ingroup DRAFT
#  \brief Provide code to convert certain shapes into SVG elements.
                ...
                if round(c.Axis.getAngle(drawing_plane_normal), 2) in [0, 3.14]:
                    ...
                    if not done:
                        if len(e.Vertexes) == 1 and iscircle:
                            ...
                            endpoints = [getProj(c.value(_diff), plane),
